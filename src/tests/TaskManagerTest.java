...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    void addSubtaskTest() {
        ...
        subtask = new Subtask("Test subtask for history", "test description", Status.NEW, epicId);
    ...
    void updateEpicStatusTest() {
        ...
        manager.addTask(new Subtask("Test subtask2", "test description", Status.NEW, epicId));
        //у подзадач статусы NEW и DONE
        assertEquals(Status.IN_PROGRESS, manager.getEpicTaskById(epicId).getStatus());

        manager.addTask(new Subtask("Test subtask3", "test description", Status.IN_PROGRESS, epicId));
    ...
    void updateTaskTest() {
        ...
        Task updatedTask = new Task(taskId, "updated1 task", "test description", Status.IN_PROGRESS);
        ...
        updatedTask = new Task(taskId + 1, "updated2 task", "test description", Status.IN_PROGRESS);
    ...
    void getSubtasksOfEpicTest() {
        ...
        for (int i = 0; i < 5; i++) {
            Subtask sub = new Subtask("Test subtask" + i, "test description", Status.NEW, epicId);
